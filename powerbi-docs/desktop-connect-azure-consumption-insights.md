...
觀看 [How to analyze spending in Power BI with Azure Consumption Insights](https://www.youtube.com/watch?v=QKBMXXrlpEk) (如何在 Power BI 中使用 Azure 使用量見解分析費用)。 此影片會說明在 Power BI Desktop 中使用 Azure 使用量見解連接器來檢閱您的成本資料。
