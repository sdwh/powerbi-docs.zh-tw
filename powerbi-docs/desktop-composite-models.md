...
使用 DirectQuery 時，您應該一律考量效能，主要是為了確保後端來源有充足的資源，以便為使用者提供良好的體驗。 良好的體驗表示視覺效果在五秒內重新整理。 如需更多效能建議，請參閱[如何在 Power BI 中使用 DirectQuery](desktop-directquery-about.md)。
