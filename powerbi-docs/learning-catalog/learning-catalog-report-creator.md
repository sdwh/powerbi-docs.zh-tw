...
| 內容 | 描述  | 格式 | 長度   |
|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|----------------|
| [透過 Power BI 建立及使用分析報表](https://docs.microsoft.com/learn/paths/create-use-analytics-reports-power-bi/)  | 此學習路徑會介紹 Power BI，並教導如何使用及建置商業智慧型報表。  | 免費的自學型線上學習路徑 | 6 小時 22 分鐘      |
| [準備資料以供 Power BI 使用](https://youtu.be/l2wy4XgQIu0) (英文)  | 觀看幾個簡單的祕訣，以準備 Excel 資料供 Power BI 使用。 | 1 分鐘 20 秒      |
...
| [PowerBI.Tips 擁有者提供的 Power 技巧、祕訣與工具](https://www.youtube.com/watch?v=fnj1_e3HXow) (英文) | 在這個非常特殊的使用者群組會議中，PowerBI.Tips 與 Power BI MVP 的擁有者 Seth Bauer 和 Mike Carlo，將分享在過去 18 個月內，兩人發佈到 http://PowerBI.Tips 的大量 Power 技巧、祕訣與工具  | YouTube 影片  | 1 小時 7 分鐘 40 秒 |
