...
---
# <a name="qa-in-power-bi"></a>Power BI 中的問與答
...
[如何使用問與答](service-how-to-q-and-a.md)：使用問與答的逐步解說，以及問與答運作方式的概觀。
...
[啟用內部部署資料集的問與答](service-q-and-a-direct-query.md)

[教學課程：使用 Power BI 問與答與零售範例](power-bi-visualization-introduction-to-q-and-a.md)：使用實際業界教學課程的問與答。
