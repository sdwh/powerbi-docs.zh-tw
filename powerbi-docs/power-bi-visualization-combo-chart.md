---
title: "Power BI 中的組合圖 (教學課程)"
description: "這份文件為教學課程 (附有影片)，說明在 Power BI 中建立組合圖的原因和方式。"
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
若要建立自己的組合圖，請登入 Power BI 並選取 [取得資料] \> [範例]\> [零售分析範例]。 
...
5. 選取視覺效果右上角的省略符號 (...)，然後選取 [Sort by FiscalMonth]\(依 FiscalMonth 排序)。
...
1. 建立依月份追蹤去年毛利率 % 的新折線圖。  一月的 GM% 為 35%，尖峰在 4 月為 45%，於 7 月下降並再次於 8 月達到尖峰。 我們去年和今年會看到類似的銷售模式嗎？
   
   ![](media/power-bi-visualization-combo-chart/combo1_new.png)
2. 將 [今年度銷售額 > 值] 和 [去年度銷售額] 新增至折線圖。 [去年 GM %]  的刻度遠小於 [銷售額]  的刻度，因此難以比較。      
   
   ![](media/power-bi-visualization-combo-chart/flatline_new.png)
3. 若要使視覺效果更容易閱讀及解譯，請將折線圖轉換成折線與堆疊直條圖。
   
   ![](media/power-bi-visualization-combo-chart/converttocombo_new.png)
4. 將 [去年毛利率 %]  從 [資料行值]  拖曳到 [行值] 。 Power BI 會建立兩個軸，因此可用不同方式調整資料集；左邊的量值為金額，而右邊的量值則為百分比。
...
4. 在 [Y 軸 (欄)] 下，也請確認 [顯示次要] 已設為 [開啟]。 這會顯示用於設定組合圖中折線圖部分格式的選項。
...
在組合圖中反白顯示直條或折線會交叉篩選報表頁面上的其他視覺效果，反之亦然。
