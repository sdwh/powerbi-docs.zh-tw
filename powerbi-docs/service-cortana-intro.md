---
title: 使用 Cortana 來尋找及檢視報表和儀表板 - Power BI
...
ms.locfileid: "73853668"
---
# <a name="find-and-view-your-power-bi-data-with-cortana-for-power-bi"></a>使用 Cortana for Power BI 尋找並檢視您的 Power BI 資料
...
一段時間之後，您現在已可以[使用 Cortana 擷取某些類型的報表頁面](service-cortana-answer-cards.md)。 現在我們已新增**新體驗** -- 也會擷取儀表板的能力。 請試用，並[在 Power BI Ideas 傳送意見反應給我們](https://ideas.powerbi.com/forums/265200-power-bi)。 最後，「新體驗」  將擴充成包含 Cortana 一併搜尋報表。  新體驗的其中一個重要優點在於您設定時不需要進行特殊處理 (不允許 Cortana 或設定 Windows 10)。 它會正常運作。
...
提供四份文件引導您設定及使用適用於 Power BI 的 Cortana。
...
## <a name="how-cortana-and-power-bi-work-together"></a>Cortana 和 Power BI 如何搭配運作
...
* "show me customer"「不會」  傳回 Power BI 儀表板結果。   
* 表達例如 "show me customer profitability"、"customer p"、"customer s"、"profitability sample"、"michele hart sample"、"show customer profitability sample" 和 "show me customer p"「會」  傳回 Power BI 結果。
...
報表的基礎技術會使用 [Power BI問與答](power-bi-tutorial-q-and-a.md)。
...
2. Cortana 準備就緒之後，請在 Cortana 搜尋列中鍵入或說出問題。 Cortana 會顯示可用的結果。 如果有符合問題的 Power BI 儀表板，就會顯示在 [最佳相符]  或 [Power BI]  下方。
     ...
     ![Cortana 搜尋會尋找 Power BI 儀表板](media/service-cortana-intro/power-bi-cortana-search-hr.png "Cortana 尋找 Power BI 儀表板")
...
5. 選取 [Cortana stores]  報表頁面，以在 Cortana 視窗中予以顯示。
    ...
    ![報表頁面在 Cortana 中開啟](media/service-cortana-intro/power-bi-report-cortana-opens.png "報表頁面在 Cortana 中開啟")   
...
8. 在 Power BI 中，開啟報表頁面。    
     ![從 Cortana 開啟報表](media/service-cortana-intro/power-bi-cortana-open2.png "Cortana 回應卡在 Cortana 搜尋中開啟

## <a name="considerations-and-troubleshooting"></a>考量與疑難排解
* Cortana 無法存取任何未對 [Power BI 啟用](service-cortana-enable.md)的 Cortana 卡片。
