...
附有圖格、報告或視覺效果快照集的郵件也包括 Power BI 服務上實際物件的連結 ([https://powerbi.com](https://powerbi.com))。 如果您和您的收件者都具有 Power BI Pro 授權或內容位於[進階容量](service-premium.md)中，且您已經與收件者共用項目，收件者只需按一下連結就能直接前往磚、報表或視覺效果。 
