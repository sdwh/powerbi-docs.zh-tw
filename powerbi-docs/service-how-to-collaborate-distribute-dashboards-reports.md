...
在 Power BI 服務中可以輕鬆地找到並安裝應用程式 ([https://powerbi.com](https://powerbi.com))。 您可以將應用程式的直接連結傳送給商務使用者，或者他們可以在 AppSource 中進行搜尋。 深入了解如何[發佈您的應用程式](service-create-distribute-apps.md#publish-your-app)。 
