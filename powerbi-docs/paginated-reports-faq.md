...
容量管理員可以在容量管理員入口網站頁面中，啟用或停用編頁報表工作負載。  根據預設，對於您建立的任何新容量，將開啟工作負載。  
...
我們最近發行了 Power BI 報表產生器，作為 Power BI 服務中編頁報表的主要編寫工具。 從 Microsoft 下載中心安裝 [Power BI 報表產生器](https://go.microsoft.com/fwlink/?linkid=2086513)。
...
是。 我們最近已新增以下支援：從 Power BI 報表產生器開啟報表，並將它們直接發佈至服務。
