...
使用 Power BI Desktop 的 [發佈]，實際上就是使用 Power BI 的 [取得資料] 從本機磁碟匯入檔案或連接到 OneDrive 上的檔案。  以下是快速操作說明，但您可以參閱[從 Power BI Desktop 發佈](../create-reports/desktop-upload-desktop-files.md)以深入了解。
