...
1. 在範本工作區中，選取 [建立應用程式]  。
    ...
    **瀏覽**
    ...
    啟動 [新的瀏覽產生器]  ，您可以在其中定義應用程式的導覽窗格 (請參閱本文中的[設計瀏覽體驗](../collaborate-share/service-create-distribute-apps.md#design-the-navigation-experience)以取得詳細資料)。
