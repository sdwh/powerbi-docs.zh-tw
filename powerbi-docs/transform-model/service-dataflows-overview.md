...
如需在 Premium 容量上啟用資料流程工作負載的詳細資訊，請參閱 [Configure workloads in a Premium capacity](../admin/service-admin-premium-workloads.md) (在 Premium 容量中設定工作負載) 一文。 資料流程工作負載目前無法在多地理位置容量中取得。
