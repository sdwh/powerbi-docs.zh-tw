...
* 請確定視覺效果是搭配 [Power BI 視覺效果指導方針](./guidelines-powerbi-visuals.md#guidelines-for-power-bi-visuals-with-additional-purchases)進行編譯。 **不允許任何浮水印**。
