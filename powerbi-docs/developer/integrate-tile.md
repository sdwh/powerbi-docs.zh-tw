...
GitHub 上有範例應用程式可供您檢閱。 如需詳細資訊，請參閱 [integrate-tile-web-app](https://github.com/Microsoft/PowerBI-Developer-Samples/tree/master/User%20Owns%20Data/integrate-tile-web-app)。
