...
1. 在工作區中，選取 [儀表板] 索引標籤。
2. 找到要刪除的儀表板，然後選取刪除圖示 ![刪除圖示](./media/end-user-delete/power-bi-delete-icon.png).

    ![影片](./media/end-user-delete/power-bi-delete-dash.gif)
...
1. 在工作區中，選取 [報表] 索引標籤。
2. 找到要刪除的報表，然後選取刪除圖示   ![刪除圖示](./media/end-user-delete/power-bi-delete-icon.png).   

    ![工作區的報表索引標籤](./media/end-user-delete/power-bi-delete-reportnew.png)
3. 確認刪除。

   ![[刪除報表] 對話方塊](./media/end-user-delete/power-bi-delete-report.png)
...
1. 在工作區中，選取 [活頁簿] 索引標籤。
2. 找到要刪除的活頁簿，然後選取刪除 ![刪除圖示](./media/end-user-delete/power-bi-delete-report2.png) 圖示。

    ![[活頁簿] 索引標籤](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. 確認刪除。

   ![[移除活頁簿] 對話方塊](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. 找到要刪除的資料集，然後選取省略符號 (...)。  
    ...
    ![[資料集] 索引標籤](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. 從下拉式清單中，選取 [刪除]。

   ![省略符號功能表](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. 確認刪除。

   ![[刪除儀表板] 對話方塊](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. 從左側導覽中，選取 [工作區]
    ...
    ![應用程式工作區](./media/end-user-delete/power-bi-delete-workspace.png)
2. 選取要刪除之工作區右邊的省略符號 (...)，然後選擇 [編輯工作區]。

   ![省略符號功能表 > [編輯工作區]](./media/end-user-delete/power-bi-edit-workspace.png)
3. 在 [編輯工作區] 視窗中，選取 [刪除工作區] > [刪除]。

    ![刪除工作區](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. 在右上角選取省略符號 (...)，然後選擇 [Leave workspace]\(保留工作區) > 保留。
      ...
      ![離開工作區](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. 將滑鼠游標移至要刪除的應用程式上方，然後選取刪除 ![](./media/end-user-delete/power-bi-delete-report2.png) 圖示。

   ![選取 [應用程式]](./media/end-user-delete/power-bi-delete-app.png)

   如果您不小心移除應用程式，則有數個選項可以進行復原。  您可以要求應用程式建立者重新傳送它、找到包含應用程式連結的原始電子郵件、檢查[通知中心](end-user-notification-center.md)以查看是否仍列出該應用程式的通知，或者檢查組織的 [AppSource](end-user-apps.md)。

## <a name="considerations-and-troubleshooting"></a>考量與疑難排解
本文涵蓋如何刪除 Power BI 服務的主要建置組塊。 但您在 Power BI 中還有其他可刪除的項目。  

* [移除精選儀表板](end-user-featured.md#change-the-featured-dashboard)
* [移除儀表板 (將儀表板移除最愛)](end-user-favorite.md)
* [刪除報表頁面](end-user-delete.md)
* [刪除儀表板磚](../service-dashboard-edit-tile.md)
* [刪除報表視覺效果](end-user-delete.md)
