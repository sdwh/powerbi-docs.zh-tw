...
Power BI Pro 是個別的授權，可允許存取 Power BI 服務中的所有內容和功能。 您甚至可以共用內容，並與其他 Pro 使用者共同作業。 只有 Pro 使用者能將內容發佈到工作區、共用儀表板，以及訂閱儀表板和報表。
...
Power BI Desktop 是免費應用程式，您可直接在自己的電腦上安裝。 Power BI Desktop 與 Power BI 服務密切合作。  資料科學家、系統管理員，以及開發人員可以使用 Power BI Desktop 產生報表，並提供給 Power BI 服務「取用者」  。 閱讀更多有關[什麼是 Power BI Desktop](../desktop-what-is-desktop.md) 的內容。
