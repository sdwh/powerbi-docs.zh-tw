---
title: Power BI 中可供取用者使用的視覺效果類型
...
本文概述隨 Power BI 一同封裝的視覺效果。  這些是您最常遇到的視覺效果。 
...
![直條圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_bar.png)

 ![橫條圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_col.png)

橫條圖是查看不同類別間特定值的標準作法。

### <a name="cards-single-number"></a>卡片：單一數字
![單一數字卡片](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_card.png)

單一數字卡片會顯示單一事實 (即單一資料點)。 有時您在 Power BI 儀表板或報告中追蹤的最重要項目是一個單一數字，例如總銷售額、歷年的市佔率，或總商機。  

### <a name="cards-multi-row"></a>卡片：多列
![多列卡片](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/multi-row-card.png)

多列卡片會顯示一或多個資料點，每個資料列各一個。


### <a name="combo-charts"></a>組合圖
![組合圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/combosmall.png)
...
![環圈圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/donutsmall.png)

環圈圖類似於圓形圖。  它們會顯示部分與整體的關聯性。 唯一的差別在於，中央為空白，且保留空間給標籤或圖示。

### <a name="funnel-charts"></a>漏斗圖
![漏斗圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_funnel.png)
...
![量表圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/gauge_m.png)
...
![折線圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_line.png)

折線圖強調完整連續值的整體圖形，通常是一段期間。

### <a name="maps-basic-maps"></a>地圖：基本地圖
![基本地圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi-nancy_viz_map.png)

使用基本地圖建立類別和數量資訊與空間位置的關聯。

### <a name="maps-arcgis-maps"></a>地圖：ArcGIS 地圖
![ArcGis 地圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/power-bi-esri-map-theme2.png)
...
![區域分布圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_filledmap.png)

區域分布圖使用陰影、濃淡或圖樣，顯示值的比例如何隨著地理位置或地區而有所不同。 可使用範圍介於淺色 (較不常見/較低) 到深色 (較常見/較多) 的陰影，快速顯示這些相對差異。

### <a name="maps-shape-maps"></a>地圖：圖形地圖
![圖形地圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/power-bi-shape-map2.png)

圖形地圖會使用色彩來比較地圖上的區域。 不同於地圖視覺效果，圖形地圖無法在地圖上顯示資料點的確切地理位置。 相反地，其主要目的是要藉由不同的著色，在地圖上顯示區域的相對比較。

### <a name="matrix"></a>矩陣圖
![矩陣](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/matrix.png)
...
![圓形圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_pie.png)
...
![泡泡圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_bubble.png)
...
![高密度散佈圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/density-scatter.png)

根據定義，取樣高密度資料可在合理範圍內快速建立互動回應的視覺效果。 高密度取樣會使用消除重疊點的演算法，並確保視覺效果會呈現資料集中的所有點。 它不只會繪製代表性的資料樣本。  

還可確保提供回應、轉譯和清楚保留整體資料集中重要點的最佳組合。

### <a name="slicers"></a>交叉分析篩選器
![交叉分析篩選器](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_slicer.png)
...
![獨立影像](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_image.png)

獨立影像是已新增至報表或儀表板的圖形。 


### <a name="tables"></a>資料表
![資料表](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/tabletype.png)
...
![矩形式樹狀結構圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_tree.png)
...
![瀑布圖](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/waterfallsmall.png)
