...
## <a name="open-the-power-bi-service"></a>開啟 Power BI 服務


若要開始，請開啟 Power BI 服務 (app.powerbi.com) 並巡覽至 [首頁]  。 
1. 如果左瀏覽窗格已摺疊，請選取瀏覽窗格圖示 ![具有 3 條水平線的圖示](./media/end-user-experience/power-bi-burger.png) 加以展開。 
...
![應用程式工作區畫面](./media/end-user-experience/power-bi-app-workspace.png)
...
![顯示更多動作選項的應用程式工作區畫面](./media/end-user-experience/power-bi-workspace-app.png)

工作區也是您資料的其中一個路徑。 從清單選取儀表板或報表加以開啟。  將游標暫留在星號圖示上並選取該圖示，以將儀表板或報表設為我的最愛。 如果「設計師」  提供您[共用權限](end-user-shared-with-me.md)，則暫留時也會顯示該動作。 

![暫留時顯示的功能表](./media/end-user-experience/power-bi-hover.png)

選取儀表板名稱，以開啟儀表板。

![儀表板已開啟](./media/end-user-experience/power-bi-dashboard-open.png)
...
1. 在儀表板開啟的情況下，從功能表列選取 [我的最愛]  。
   ...
   ![新增我的最愛](./media/end-user-experience/power-bi-select-favorite.png)
   
   [我的最愛]  會變成 [移除最愛]  ，且星狀圖示會變成黃色。
   
   ![移除我的最愛](./media/end-user-experience/power-bi-unfavorite.png)
...
![排序內容](./media/end-user-experience/power-bi-sort-date.png)


若要深入了解，請參閱 [Power BI 導覽：搜尋和排序](end-user-search-sort.md)

## <a name="power-bi-home"></a>Power BI 首頁
...
3. 將游標暫留在儀表板、報表或資料集上，然後選取 [更多選項 (...)]   > [刪除]  。 重複執行，直到移除所有三項。
    ...
    ![刪除儀表板](./media/end-user-experience/power-bi-delete.png)
