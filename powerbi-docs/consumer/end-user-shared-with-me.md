...
根據擁有者授與您的權限，您將有許多選項可以與儀表板和基礎報表互動。 這些包括可以建立儀表板的複本、以[閱讀檢視](end-user-reading-view.md)開啟報表，以及重新與其他同事共用。

## <a name="actions-available-from-the-shared-with-me-screen"></a>可從 [與我共用] 畫面使用的動作
* 選取星狀圖示，以[將儀表板設為最愛](end-user-favorite.md)。
* [移除儀表板](end-user-delete.md)  ![垃圾桶圖示](./media/end-user-shared-with-me/power-bi-delete-icon.png)
* 部分儀表板可以重新予以共用  ![共用圖示](./media/end-user-shared-with-me/power-bi-share-icon-new.png)
* 此外，如果您的儀表板清單太長，請[使用搜尋欄位和排序找出您需要的內容](end-user-search-filter-sort.md)。
...
![依擁有者篩選的儀表板](./media/end-user-shared-with-me/power-bi-owner.png)
