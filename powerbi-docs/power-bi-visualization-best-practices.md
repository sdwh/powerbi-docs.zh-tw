...
一項對於網頁內色彩和視覺效果運用的研究，發現色彩之間對比度較高者會增加理解速度 (The effect of text and background colour on visual search of Web pages (文字和背景色彩對網頁之視覺效果搜尋的影響) 和 **Determining Users’ Perception of Web Page Visual Complexity and Aesthetic Characteristics** (判斷使用者對網頁視覺效果複雜性和美學特性的認知))。
