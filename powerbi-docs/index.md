                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Power BI 服務</h3>
                                                    <p>Power BI 服務是線上服務，您可以在其中找到儀表板、應用程式及已發行的報表。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Power BI Desktop 可讓您建立進階查詢、模型，以及將資料視覺化的報表。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Power BI 行動應用程式</h3>
                                                    <p>檢視您的行動裝置上的 Power BI 儀表板和報表，並與其互動。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Power BI 開發人員</h3>
                                                    <p>Power BI 提供各種開發人員選項。 範圍包括內嵌、自訂視覺效果和串流資料集。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Power BI 報表伺服器</h3>
                                                    <p>建立、部署及管理 Power BI、行動和內部部署的編頁報表。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
