...
* [Power BI 管理入口網站](https://app.powerbi.com/admin-portal)
* [Office 365 系統管理中心](https://portal.office.com/adminportal/home)

如需有關 Power BI 服務系統管理員角色的詳細資訊，請參閱[了解 Power BI 系統管理員角色](service-admin-role.md)。
...
> [!NOTE]
> 您的帳戶必須在 Office 365或 Azure Active Directory 中標示為 **全域管理員** ，才能存取 Power BI 管理入口網站。
> 
> 
