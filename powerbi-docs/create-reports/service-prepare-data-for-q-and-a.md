...
* 如果您的活頁簿有 PowerPivot 資料模型，您就可以更進一步地最佳化。 深入了解我們內部團隊之自然語言專家的[揭密 Power BI 問與答第 2 部分](https://powerbi.microsoft.com/blog/demystifying-power-bi-q-amp-a-part-2/)。
...
- [(為 Power BI) 取得資料](../connect-data/service-get-data.md)  
