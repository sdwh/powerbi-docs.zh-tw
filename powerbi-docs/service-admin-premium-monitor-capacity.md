...
**目前的應用程式版本是 1.9 (已於 2018 年 11 月 14 日發行)。**
...
| **資料集工作負載** | * 過去七天內的重新整理總數<br> * 過去七天內的成功重新整理總數<br> * 過去七天內的失敗重新整理總數<br> * 由於記憶體不足而失敗的重新整理總數<br> * 平均重新整理持續時間是完成作業所需的時間 (以分鐘為單位)<br> * 平均重新整理等候時間是已排程的時間與開始作業之間的平均延隔時間 (以分鐘為單位)<br> * 過去七天內執行的查詢總數<br> * 過去七天內的成功查詢總數<br> * 過去七天內的失敗查詢總數<br> * 平均查詢持續時間是完成作業所需的時間 (以分鐘為單位)<br> * 由於記憶體壓力而撤出的模型總數<br> * 資料集平均大小 <br> * 載入記憶體之資料集的平均計數 |
|  |  |
