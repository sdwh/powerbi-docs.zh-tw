...
### <a name="dig-deeper"></a>深入瞭解
- [匯入資料集以在 Power BI 服務中建立報表](service-report-create-new.md)
- [建立為 Power BI 行動裝置應用程式最佳化的報表](desktop-create-phone-report.md)
...
### <a name="dig-deeper"></a>深入瞭解
* [建立空白儀表板，然後取得一些資料](service-dashboard-create.md)。
