...
您無法直接從 Power BI Desktop 「共用」  。 您必須[將 Power BI Desktop 的報表發佈至](desktop-upload-desktop-files.md) Power BI 服務。 不過，您可以[從 Power BI 行動裝置應用程式共用儀表板](consumer/mobile/mobile-share-dashboard-from-the-mobile-apps.md)。  
