---
title: "Power BI Desktop 中的雙向交叉篩選 (預覽)"
...
---
# <a name="bidirectional-cross-filtering-using-directquery-in-power-bi-desktop-preview"></a>在 Power BI Desktop 中使用 DirectQuery 雙向交叉篩選 (預覽)
